.data
	...
	result_message: .asciiz "El número menor es: "
.text
main:
	# Asignando el contador a $t0
	li $t0, 0
	
	# Asignando el menor a $t1. Suponiendo que el maximo número sea 9999999
	li $t1, 9999999
...
loop:
	...
	# Si $t3 == 0, significa que el número no es menor, 
...
end_loop:
	...
	# Imprime "El numero menor es: "
	li $v0, 4
	la $a0, result_message
	syscall
	
	# Imprime $t1 (el número menor)
	li $v0, 1
	move $a0, $t1
	syscall
